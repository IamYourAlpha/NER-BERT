# Following utils are copies from https://github.com/AberHu/Knowledge-Distillation-Zoo/blob/master/train_base.py
# also some of this utils are copies from my own repository https://github.com/IamYourAlpha/DeepExpertEnsembles
